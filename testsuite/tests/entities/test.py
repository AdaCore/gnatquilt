...
with FirefoxDriver() as driver:
    ...
    driver.check_file_stat("Prj1", "pk1.adb", CoverageStatus.COVERED, 0)
    driver.check_file_stat("P", "t1.adb", CoverageStatus.COVERED, 1)
    driver.check_file_stat("P", "t2.adb", CoverageStatus.COVERED, 2)

    driver.report_on_entities([Entities.Stmt])
    driver.check_project_stat("P", CoverageStatus.COVERED, 5)
    driver.check_total_stat(CoverageStatus.NOT_COVERED, 2)
    ...
    driver.check_total_stat(CoverageStatus.COVERED, 10)

    driver.report_on_lines()
    driver.check_total_stat(CoverageStatus.COVERED, 4)
